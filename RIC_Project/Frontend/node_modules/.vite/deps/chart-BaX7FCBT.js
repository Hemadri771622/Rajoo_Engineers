...
var Scale = class Scale extends Element {
	...
	_resolveTickFontOptions(index$1) {
		return toFont(this.options.ticks.setContext(this.getContext(index$1)).font);
	}
	_maxDigits() {
...
*/ function pathArc(ctx, element, offset, spacing, end, circular) {
	...
	if (spacing) {
		...
		spacingOffset = (alpha$1 - (avNogSpacingRadius !== 0 ? alpha$1 * avNogSpacingRadius / (avNogSpacingRadius + spacing) : alpha$1)) / 2;
	}
	const angleOffset = (alpha$1 - Math.max(.001, alpha$1 * outerRadius - offset / PI) / outerRadius) / 2;
...
function _drawfill(ctx, source, area) {
	...
	const clip = getDatasetClipArea(chart, chart.getDatasetMeta(index$1));
...
function findOrAddLabel(labels, raw, index$1, addedLabels) {
	...
	return first !== labels.lastIndexOf(raw) ? index$1 : first;
}
...
//# sourceMappingURL=chart-BaX7FCBT.js.map