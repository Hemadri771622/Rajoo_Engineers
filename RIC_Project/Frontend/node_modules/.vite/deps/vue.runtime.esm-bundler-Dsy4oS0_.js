...
function reduce(self$1, method, fn, args) {
	...
	return wrapInitialAccumulator ? toWrapped(self$1, result) : result;
}
			...
			const doSet = () => {
				if (rawRef.f) {
					...
					if (isUnmount) isArray(existing) && remove(existing, refValue);
						...
						if (canSetRef(ref$1, rawRef.k)) ref$1.value = newVal;
					...
					if (canSetRef(ref$1, rawRef.k)) ref$1.value = value;
...
function baseCreateRenderer(options, createHydrationFns) {
	...
	const unmount = (vnode, parentComponent, parentSuspense, doRemove = false, optimized = false) => {
		const { type, props, ref: ref$1, children, dynamicChildren, shapeFlag, patchFlag, dirs, cacheIndex, memo } = vnode;
...
//# sourceMappingURL=vue.runtime.esm-bundler-Dsy4oS0_.js.map