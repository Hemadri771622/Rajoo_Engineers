...
export default {
  ...
  data() {
    return {
      ...
      clockInterval: null,      // ✅ added
      telemetryHandler: null    // ✅ added
    };
  },
  ...
  mounted() {
    ...
    // ✅ Named handler (fixes duplicate listeners)
    this.telemetryHandler = (data) => {
      ...
      // ✅ full 30 points at once (same logic)
    ...
    thicknessChartData() {
      ...
      return {
        ...
        datasets: [
          ...
          {
            label: "Set Thickness",
            data: this.thicknessSetTrend.map(p => p.y),
            borderColor: "#4dd0e1",
